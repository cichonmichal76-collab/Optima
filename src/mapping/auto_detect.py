...
FIELD_ALIASES: dict[str, list[str]] = {
    ...
    "amount": ["kwota", "wartosc", "wartość", "kwota dokumentu", "kwota dok", "kwota dok."],
    "paid_amount": ["zaplacono", "zapłacono", "kwota zaplacona", "kwota zapłacona", "suma rozliczen", "suma rozliczeń", "kwota rozliczona"],
