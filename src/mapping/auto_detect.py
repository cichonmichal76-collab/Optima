...
FIELD_ALIASES: dict[str, list[str]] = {
    ...
    "contractor_name": ["kontrahent", "nazwa kontrahenta", "nazwa", "firma"],
    ...
    "accounting_date": ["data ksiegowania", "data księgowania"],
    ...
    "journal": ["dziennik", "rejestr ksiegowy", "dziennik czastkowy"],
