...
DEFAULT_TEMPLATES: dict[str, dict[str, Any]] = {
    "FZ_VAT_100": {
        ...
        "warnings": ["Przetestuj projekt schematu w bazie DEMO przed wdrozeniem."],
        "lines": [
            ...
            {"side": "MA", "account": "{{supplier_account}}", "amount_expression": "gross", "description": "Rozrachunek z dostawca"},
        ],
    },
    "FZ_PALIWO_50": {
        "name": "FZ paliwo VAT 50%",
        "condition": "document_type == 'FZ' and category == 'PALIWO'",
        "warnings": ["Zweryfikuj podzial VAT odliczonego i nieodliczonego."],
        "lines": [
    ...
    "FZ_BEZ_VAT": {
        ...
        "warnings": ["Zweryfikuj podstawe zwolnienia lub NP."],
        "lines": [
    ...
    "FS_23": {
        ...
        "warnings": ["Zweryfikuj konta przychodowe oraz konto VAT naleznego."],
        "lines": [
            {"side": "WN", "account": "{{customer_account}}", "amount_expression": "gross", "description": "Naleznosc od odbiorcy"},
            {"side": "MA", "account": "{{revenue_account}}", "amount_expression": "net", "description": "Przychod"},
            {"side": "MA", "account": "{{vat_due_account}}", "amount_expression": "vat", "description": "VAT nalezny"},
        ],
    },
    "WB_BANK_FEE": {
        "name": "WB oplata bankowa",
        "condition": "document_type == 'WB' and kind == 'BANK_FEE'",
        "warnings": ["Zweryfikuj konto kosztow finansowych."],
        "lines": [
    ...
    "AMORT": {
        ...
        "warnings": ["Zweryfikuj konto umorzenia i rodzaj srodka trwalego."],
        "lines": [
    ...
    "LP": {
        "name": "LP lista plac podstawowa",
        "condition": "document_type == 'LP'",
        "warnings": ["Zweryfikuj konta wynagrodzen, ZUS i podatku."],
        "lines": [
            {"side": "WN", "account": "{{salary_cost_account}}", "amount_expression": "gross_salary", "description": "Koszt wynagrodzen"},
            {"side": "MA", "account": "{{employee_liability_account}}", "amount_expression": "net_salary", "description": "Wyplata netto"},
